...
#This function structures data to facilitate  analysis
def wrangle_data():
...
#This function fits ANOVA to data and computes test statistics
...
def define_permutations(data, numPermutations):
    ...
    for df, cond_label in data:
        ...
        for subj in subjects:
            ...
            #where keys are permutation numbers and values are the shuffled list
        ...
        #create dataframes from the subj_clust_permutations and subj_eff_permutations
        ...
        #columns, their will now be n rows for each permutation per subject  
        ...
        #store cluster  and local efficiency permutations relative to 
        #their condition. Ie. Key is condition (enc or retr). Values is 
...
def structure_permutations(permuted_dfs):
    ...
    for cond in permuted_dfs.keys():
        ...
        for metric, df in permuted_dfs[cond].items():
            ...
            #Assign race and accuracy factors to each observation. Data 
...
#store data in dictionary object to pass into functions
...
permuted_dfs, numPermutations = define_permutations(observed_data, numPermutations = 10)

#The dataframes with all permutations still need to be structured in accordance
